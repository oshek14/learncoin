...
uint256 hashGenesisBlock("0xf372b4a8eafb023f59d60936c1c7ffc83d916c892d1142990915176d1487a971");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf372b4a8eafb023f59d60936c1c7ffc83d916c892d1142990915176d1487a971");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("243584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    =1533713622;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1237808;
        ...
        assert(block.hashMerkleRoot == uint256("0x45b4558eea09a4a5ffac900d0e4ffdb217c1d6f6b952b37f1a36613ab49a7705"));
